...
public class SwipeListener implements View.OnTouchListener {
    ...
    public void setDelView(View delView) {
        this.delView = delView;
    }

    public void setLoveView(View loveView) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (delView != null && loveView != null) {
                    if (alpha > 0) {
                        loveView.setScaleX(1 + alpha / 10);
                        loveView.setScaleY(1 + alpha / 10);
                    }

                    if (alpha < 0) {
                        delView.setScaleX(1 - alpha / 10);
                        delView.setScaleY(1 - alpha / 10);
                    }
                    ...
                    if (alpha == 0) {
                        ...
                        loveView.setScaleY(1);
                        loveView.setScaleX(1);
                    }
                }
                if (rightView != null && leftView != null) {
                    ...
                    if (alpha > 0) {
                        ...
                        rightView.setScaleX(1 + alpha);
                        rightView.setScaleY(1 + alpha);
                    }

                    if (alpha < 0) {
                        leftView.setAlpha(-alpha);
                        leftView.setScaleY(1 - alpha);
                        leftView.setScaleX(1 - alpha);
                    }
