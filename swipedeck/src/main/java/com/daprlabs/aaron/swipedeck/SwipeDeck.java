...
public class SwipeDeck extends FrameLayout {
    ...
    private void addLastView(int duration) {
        ...
        if (positionOfLastCard >= 0) {
            ...
            TranslateAnimation translateAnimation = new TranslateAnimation(-getWidth() * 2, 0, 0, 0);
            RotateAnimation rotateAnimation = new RotateAnimation(-30, 0);
            animationSet.addAnimation(translateAnimation);
            animationSet.addAnimation(rotateAnimation);
            animationSet.setDuration(duration);
            newBottomChild.setAnimation(animationSet);
//            newBottomChild.animate()
//                    .setDuration(300)
//                    .x(getWidth() * 2)
//                    .y(getPaddingTop())
//                    .rotation(30);
