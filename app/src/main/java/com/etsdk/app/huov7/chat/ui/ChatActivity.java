package com.etsdk.app.huov7.chat.ui;
...
import com.etsdk.app.huov7.chat.modle.FileMessage;
import com.etsdk.app.huov7.chat.modle.FriendProfile;
import com.etsdk.app.huov7.chat.modle.FriendshipInfo;
import com.etsdk.app.huov7.chat.modle.GroupInfo;
import com.etsdk.app.huov7.chat.modle.ImageMessage;
import com.etsdk.app.huov7.chat.modle.Message;
import com.etsdk.app.huov7.chat.modle.MessageFactory;
import com.etsdk.app.huov7.chat.modle.TextMessage;
import com.etsdk.app.huov7.chat.modle.VideoMessage;
import com.etsdk.app.huov7.chat.modle.VoiceMessage;
import com.etsdk.app.huov7.chat.utils.FileUtil;
import com.etsdk.app.huov7.chat.utils.MediaUtil;
import com.etsdk.app.huov7.chat.utils.RecorderUtil;
...
public class ChatActivity extends FragmentActivity implements ChatView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setBackImg(R.mipmap.back);
        switch (type) {
            case C2C:
                title.setMoreImg(R.drawable.chat_detail);
                if (FriendshipInfo.getInstance().isFriend(identify)) {
                    ...
                    title.setMoreImgAction(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            OtherInfoActivity.start(ChatActivity.this, identify.substring(2, identify.length()));
                        }
                    });
                    ...
                    TIMFriendshipManager.getInstance().getUsersProfile(users, new TIMValueCallBack<List<TIMUserProfile>>() {
                        ...
                        public void onSuccess(List<TIMUserProfile> timUserProfiles) {
                            title.setTitleText(StringUtils.isEmpty(timUserProfiles.get(0).getNickName()) ? identify : timUserProfiles.get(0).getNickName());
                        }
                    });
                ...
                break;
            case Group:
                title.setMoreImg(R.drawable.group_chat_detail);
                title.setMoreImgAction(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
