...
import com.etsdk.app.huov7.iLive.model.RecordInfo;
...
public class UserServerHelper {
    ...
    public String post(String url, String json) throws IOException {
        if (bDebug){
            L.d(TAG, "postReq->url:"+url);
            L.d(TAG, "postReq->data:"+json);
        }
...
//    }
    ...
    public String getGetLinkSig(String id, String roomid) {
        try {
            ...
            String json = jasonPacket.toString();
            L.d(TAG, "getGetLinkSig->req:"+json);
            String response = post(GET_LINK_SIG, json);
            L.d(TAG, "getGetLinkSig->rsp:"+response);
