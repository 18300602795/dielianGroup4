...
//        context.startActivity(intent);
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return AileApplication.getInstance().getResources().getString(R.string.summary_me)+
                            AileApplication.getInstance().getResources().getString(R.string.summary_group_invite)+
                            to+
                            AileApplication.getInstance().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                AileApplication.getInstance().getResources().getString(R.string.summary_group_invite)+
                                AileApplication.getInstance().getResources().getString(R.string.summary_me)+
                                AileApplication.getInstance().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                AileApplication.getInstance().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return AileApplication.getInstance().getResources().getString(R.string.summary_me)+
                            AileApplication.getInstance().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+AileApplication.getInstance().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return AileApplication.getInstance().getString(R.string.conversation_system_group);
    }
