...
import com.etsdk.app.huov7.chat.ui.AddFriendActivity;
import com.etsdk.app.huov7.chat.ui.ProfileActivity;
...
public class FriendProfile implements ProfileSummary {
    ...
    public String getGroupName(){
        if (profile.getFriendGroups().size() == 0){
            return AileApplication.getInstance().getString(R.string.default_group_name);
        }else{
