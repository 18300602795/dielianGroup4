...
public class AppApi {
    ...
    public static final String memsdetail="mem/mem_detail";
    ...
    public static final String userDetailApi2="mem/app_detail";
    ...
    //直播
    public static final String iLive_create ="create_room";
    public static final String iLive_room_list ="room_list";
    public static final String iLive_room_join ="room_join";
    public static final String iLive_room_quite ="exit_room";
    public static final String iLive_room_del ="de_room";
    public static final String iLive_wheat_on ="on_wheat";
    public static final String iLive_speaker_on ="on_speaker";
