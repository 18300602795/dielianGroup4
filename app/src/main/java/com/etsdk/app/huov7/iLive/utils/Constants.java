package com.etsdk.app.huov7.iLive.utils;
...
//    public static final int ACCOUNT_TYPE = 11656;
    ...
    public static final int ACCOUNT_TYPE = 11851;
    ...
    public static final int GIFT_TYPE = 101;
    public static final int INVITE_VOICE = 102;
    public static final int APPLY_VOICE = 103;
    public static final int DOWN_VOICE = 104;
    public static final int DOWN_VOICE_NOTICE = 105;
    public static final int UP_VOICE_NOTICE = 106;
    public static final int UP_VOICE = 107;
    public static final int CLOSE_VOICE = 108;
    ...
    public static final int SEND_GIFT = AVIMCMD_MULTI_HOST_SWITCH_CAMERA + 1; ////发送礼物
