package com.etsdk.app.huov7.iLive.views.customviews;
                ...
                for (int j = 0; j < data.getElementCount(); j++) {
                    ...
                    if (data.isSelf()) {
                        if (mVideoPlayActivity != null)
                            mVideoPlayActivity.refreshText(data.getSender(), textElem.getText(), MySelfInfo.getInstance().getNickName(), AileApplication.faceUrl, Constants.TEXT_TYPE);
//                        handleTextMessage(elem, MySelfInfo.getInstance().getNickName());
                        ...
                        if (mVideoPlayActivity != null)
                            mVideoPlayActivity.refreshText(data.getSender(), textElem.getText(), name, sendUser.getFaceUrl(), Constants.TEXT_TYPE);
                    }
                }
